...
export const taglineParts = [
  ...
  { text: "AI/ML", color: "hsl(217 75% 62%)" },
  { text: ", " },
  { text: "full-stack", color: "hsl(199 90% 65%)" },
  { text: ", and " },
  { text: "IoT", color: "hsl(189 70% 60%)" },
];
...
export const techCategories = [
  ...
  },
  {
    ...
    color: "hsl(199 70% 38%)",
    bg: "hsla(199, 70%, 55%, 0.08)",
    border: "hsla(199, 70%, 55%, 0.2)",
    items: [
      "Deep Learning",
      "LLM Fine-tuning",
...
export const projects = [
  {
    ...
    accent: "hsl(217 75% 52%)",
    accentBg: "hsla(217, 75%, 52%, 0.08)",
    inProgress: true,
  },
  {
    icon: BarChart3,
    ...
    accent: "hsl(199 90% 36%)",
    accentBg: "hsla(199, 90%, 55%, 0.08)",
  },
  {
    icon: Sprout,
    title: "GardenBuddy",
    ...
    accent: "hsl(231 60% 48%)",
    accentBg: "hsla(231, 60%, 48%, 0.08)",
    inProgress: true,
  },
  {
    icon: Bot,
    ...
    accent: "hsl(189 70% 34%)",
    accentBg: "hsla(189, 70%, 52%, 0.08)",
  },
  {
    icon: Mic,
    title: "VoiceGPT",
    ...
    accent: "hsl(217 65% 52%)",
    accentBg: "hsla(217, 65%, 52%, 0.08)",
  },
  {
    icon: Brain,
  ...
  },
  {
    ...
    accent: "hsl(199 70% 38%)",
    accentBg: "hsla(199, 70%, 50%, 0.08)",
  },
  {
    icon: Shield,
