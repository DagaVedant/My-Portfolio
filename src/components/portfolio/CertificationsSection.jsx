        ...
        <RevealSection>
          <div className="flex items-center gap-3 mb-3">
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, hsl(145 65% 52%), transparent)",
              }}
            />
            <span
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to bottom, hsl(145 65% 52% / 0.4), hsl(158 75% 52% / 0.2), transparent)",
                }}
              />
                        ...
                        <div className="flex items-start justify-between gap-2">
                          <div>
                            <p
                              ...
                              style={{ color: "hsl(145 65% 70%)" }}
                            >
                              {cert.title}
                            </p>
                            <p
                              className="text-xs"
                              style={{ color: "hsl(175 20% 50%)" }}
                            >
                              {cert.issuer}
                            </p>
                          </div>
