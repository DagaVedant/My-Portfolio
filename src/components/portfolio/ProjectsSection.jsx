  ...
  return (
    <section id="projects" className="py-32 px-6 relative overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(circle, hsl(158 75% 45%), transparent)', filter: 'blur(80px)' }}
      />
              ...
              <RevealSection key={project.title} delay={index * 100}>
                ...
                >
                  ...
                  {project.image ? (
                    ...
                    >
                      <span className="text-xs font-mono" style={{ color: project.accent + '80' }}>add project image</span>
                    </div>
                  )}
                  ...
                  <p className="text-sm leading-relaxed mb-5" style={{ color: 'hsl(175 20% 58%)' }}>
                    {project.description}
                  </p>
